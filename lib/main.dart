...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      SizedBox(height: 20,),
      Container(width: 100,height: 100,color: Color.fromARGB(255, 12, 100, 100), child: Center(child: Text("hello")),), 
      SizedBox(height: 20,),
      Container(width: 100,height: 100,color: const Color.fromARGB(255, 70, 244, 54),),
      SizedBox(height: 20,),
